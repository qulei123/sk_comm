...
{
    color_t* c = calloc(1, sizeof(color_t));
...
const char* color_hex_str(color_t c, char str[COLOR_HEX_LEN + 1]) 
{
    if (c.rgba.a == 0xff) 
    {
        snprintf(str, COLOR_HEX_LEN, "#%02X%02X%02X", (int)(c.rgba.r), (int)(c.rgba.g), (int)(c.rgba.b));
    } 
    else 
    {
        snprintf(str, COLOR_HEX_LEN, "#%02x%02x%02x%02x", (int)(c.rgba.r), (int)(c.rgba.g), (int)(c.rgba.b), (int)(c.rgba.a));
    }
...
const char* color_rgba_str(color_t c, char str[COLOR_RGBA_LEN + 1]) 
{
    ...
    snprintf(str, COLOR_RGBA_LEN, "rgba(%d,%d,%d,%1.1f)", (int)(c.rgba.r), (int)(c.rgba.g), (int)(c.rgba.b), a);
