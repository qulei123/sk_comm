...
#define pixel_dst_bpp pixel_bgr888_BPP
                                  ...
                                  const rectf_t* src_r, uint8_t a) 
{
    ...
    return_value_if_fail(dst->format == BITMAP_FMT_BGR888 && src->format == BITMAP_FMT_BGRA8888, RET_BAD_PARAMS);
...
#if 0
ret_t blend_image_rotate_bgr888_bgra8888(bitmap_t* dst, bitmap_t* src, const rectf_t* dst_r,
