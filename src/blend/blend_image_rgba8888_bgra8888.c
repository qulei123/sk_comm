...
#define pixel_dst_bpp pixel_rgba8888_BPP
                                    ...
                                    const rectf_t* src_r, uint8_t a) 
{
    ...
    return_value_if_fail(dst->format == BITMAP_FMT_RGBA8888 && src->format == BITMAP_FMT_BGRA8888, RET_BAD_PARAMS);
...
#if 0
ret_t blend_image_rotate_rgba8888_bgra8888(bitmap_t* dst, bitmap_t* src, const rectf_t* dst_r,
