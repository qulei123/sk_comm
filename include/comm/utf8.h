 ...
 */
char* utf8_from_utf16(const wchar_t* in, char* out, uint32_t size);

/**
 * @method utf8_from_utf16_ex
 *
 * 把ucs字符串转成UTF8字符串。
 *
 * @param {const wchar_t*} in 输入字符串。
...
/**
 * @method utf8_get_bytes_of_leading
 * 获取第一个字节为c的字符的字节数。 
